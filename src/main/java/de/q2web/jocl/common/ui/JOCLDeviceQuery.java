 ...
 */
package de.q2web.jocl.common.ui;
...
public class JOCLDeviceQuery {
	...
	public static void main(final String args[]) {
		...
		for (int i = 0; i < platforms.length; i++) {
			...
			System.out.println("Number of devices in platform " + platformName
					+ ": " + numDevices[0]);
		...
		for (cl_device_id device : devices) {
			...
			if ((deviceType & CL_DEVICE_TYPE_ALL) != 0) {
				System.out.printf("CL_DEVICE_TYPE:\t\t\t\t%s\n",
						"CL_DEVICE_TYPE_GPU");
			}
	 ...
	 * @return The value
	 */
	private static int[] getInts(final cl_device_id device,
			final int paramName, final int numValues) {
	 ...
	 * @return The value
	 */
	private static long[] getLongs(final cl_device_id device,
			final int paramName, final int numValues) {
	 ...
	 * @return The value
	 */
	private static String getString(final cl_device_id device,
			final int paramName) {
	 ...
	 * @return The value
	 */
	private static String getString(final cl_platform_id platform,
			final int paramName) {
		// Obtain the length of the string that will be queried
		long size[] = new long[1];
	 ...
	 * @return The value
	 */
	static long[] getSizes(final cl_device_id device, final int paramName,
			final int numValues) {
